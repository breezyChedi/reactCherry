...
declare module "expo-router" {
  ...
  // prettier-ignore
  type StaticRoutes = `/` | `/.expo/types/router.d` | `/authentication/login` | `/authentication/signup/contact` | `/authentication/signup/grade` | `/authentication/signup/personal` | `/authentication/signup/source` | `/authentication/signup/subjects` | `/authentication/signup/success` | `/components/DegreeGrid` | `/components/FacultySpinner` | `/components/UniversitiesList` | `/components/UniversityCard` | `/context/AuthContext` | `/firebaseConfig` | `/main/aps-calculator` | `/main/` | `/main/info` | `/main/profile` | `/main/universities` | `/marks` | `/nbt-info` | `/polyfills` | `/register` | `/screens/ApsInfoScreen` | `/screens/auth-screens/SignInScreen` | `/screens/MarksScreen` | `/screens/NbtInfoScreen` | `/screens/NscInfoScreen` | `/screens/RegisterScreen` | `/screens/UniversitiesScreen` | `/services/bookmarkService` | `/services/neo4jService` | `/theme` | `/types/` | `/types/navigation` | `/universities` | `/utils/DegreeFilter` | `/utils/eligibility`;
  // prettier-ignore
